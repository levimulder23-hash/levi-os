...
| 3 | Calendar | Google Calendar (levimulder23@gmail.com) | mcp (Claude connector) | connector | connected in Claude Code session | 2026-09-10 (tool list only; first read pending) |
...
| 7 | Knowledge / files | Google Drive (Alahmar), local `~/Amplify`, `~/Alahmar`, Obsidian vault (archive), `~/Desktop/Claude Notes` (archive) | Drive mcp connector; local filesystem | connector | Drive connector present, first read pending | 2026-09-10 |
